...
export default {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "links": [
          ...
          "items": [
            {
              ...
              "to": "/docs/general/Home/getting-started"
            },
            {
              "label": "API Reference",
        ...
        },
        {
          ...
          "items": [
            {
              "label": "MLGenie",
              "to": "/docs/general/MLGenie/mlgenie-overview"
            },
            {
              "label": "MarkerGenie",
              "to": "/docs/general/MarkerGenie/markergenie-overview"
            },
            {
              "label": "NotebookGenie",
              "to": "/docs/general/NotebookGenie/notebookgenie-overview"
            },
            {
              "label": "Omics",
              "to": "/docs/general/Omics/omics-overview"
            }
          ]
        },
        {
      ...
      "copyright": "Copyright © 2026 PromptBio. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
